...
const distDir = resolve(distAssetsDir, '..');
const maxLargestJsBytes = 6_000_000;

if (existsSync(resolve(distDir, 'e2e'))) {
  throw new Error('MVP bundle check failed: browser E2E harness pages must not be published in dist/e2e.');
}
