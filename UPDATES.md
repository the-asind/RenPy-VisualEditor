...
Fixed canvas drag regressions where root frames could not stay above/left of the initial import area and branch-managed trees appeared immovable after pointer-up.
