...
async def parse_script(
    ...
    """
    Upload a RenPy script file and return its content.
    Parsing is now handled client-side.
    ...
    Returns:
        JSON representation with raw content
    """
    try:
...
async def update_node_content(
    ...
    try:
        ...
        # Clients will re-fetch content and re-parse
...
async def load_existing_script(
    ...
    """
    Load an existing script and return its raw content.
    Parsing is now handled client-side.
